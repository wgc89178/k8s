#!/bin/bash
# @Author: wgc89178
# @Date:   2022-06-16 09:56:57
# @Last Modified by:   wgc89178
# @E-mail: wgc89178@163.com
#!/bin/bash
#主机信息每日巡检
...
echo -e "`date "+%Y-%m-%d %H:%M:%S"` xx平台巡检报告"  | mail -a $RESULTFILE -s "xx平台巡检报告"  wgc89178@163.com
